...
const defaultChildren = [
  {
    ...
    content: (
      <div>
        ...
        Scroll on content and it would automatically highlight buttons in a menu
        list based on the current scroll position with animated effect. If menu
        is clicked it would scroll to the selected area with animation.
      </div>
    ),
  },
  {
  ...
  React.createElement(
    'div',
    { name: item.name, id: item.name, key: item.name },
    item.content
  )
);
